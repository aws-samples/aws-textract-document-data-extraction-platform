...
SchemaFor200ResponseBodyApplicationJson = GetDocumentUploadUrlResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_document_upload_url_oapg(
        self,
...
class GetDocumentUploadUrl(BaseApi):
    ...
    def get_document_upload_url(
        ...
        return self._get_document_upload_url_oapg(
