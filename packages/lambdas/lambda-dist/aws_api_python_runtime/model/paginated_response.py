...
class PaginatedResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nextToken", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nextToken", ], str]):
