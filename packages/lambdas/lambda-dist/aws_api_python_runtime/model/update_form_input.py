...
class UpdateFormInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["extractedData", "tags", "notes", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["extractedData"]) -> MetaOapg.properties.extractedData: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["extractedData", "tags", "notes", ], str]):
