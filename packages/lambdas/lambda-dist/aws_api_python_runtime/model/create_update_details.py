...
class CreateUpdateDetails(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["updatedTimestamp"]) -> MetaOapg.properties.updatedTimestamp: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["createdBy", "updatedBy", "createdTimestamp", "updatedTimestamp", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["updatedTimestamp"]) -> typing.Union[MetaOapg.properties.updatedTimestamp, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["createdBy", "updatedBy", "createdTimestamp", "updatedTimestamp", ], str]):
