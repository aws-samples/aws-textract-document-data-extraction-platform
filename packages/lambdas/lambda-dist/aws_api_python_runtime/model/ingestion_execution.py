...
class IngestionExecution(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def status() -> typing.Type['ExecutionStatus']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'ExecutionStatus': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> 'ExecutionStatus': ...
