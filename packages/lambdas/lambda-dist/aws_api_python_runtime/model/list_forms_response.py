...
class ListFormsResponse(
        ...
        class properties:
            ...
            class forms(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['FormMetadata']:
                        return FormMetadata
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['FormMetadata'], typing.List['FormMetadata']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["forms", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["forms", ], str]):
