...
class FormSchema(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["schemaId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["schemaId", ], str]):
