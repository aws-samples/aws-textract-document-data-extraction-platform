...
class GetDocumentUploadUrlResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["documentId", "url", "location", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["documentId", "url", "location", ], str]):
