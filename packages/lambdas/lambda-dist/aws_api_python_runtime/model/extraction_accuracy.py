...
class ExtractionAccuracy(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fieldDistancePercentage"]) -> MetaOapg.properties.fieldDistancePercentage: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fieldCorrectnessPercentage"]) -> MetaOapg.properties.fieldCorrectnessPercentage: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["fieldDistancePercentage", "fieldCorrectnessPercentage", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fieldDistancePercentage"]) -> MetaOapg.properties.fieldDistancePercentage: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fieldCorrectnessPercentage"]) -> MetaOapg.properties.fieldCorrectnessPercentage: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["fieldDistancePercentage", "fieldCorrectnessPercentage", ], str]):
