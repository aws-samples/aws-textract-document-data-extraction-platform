...
RequestRequiredQueryParams = typing.TypedDict(
    ...
    {
        'pageSize': typing.Union[PageSizeSchema, int, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = ListFormReviewWorkflowTagsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_form_review_workflow_tags_oapg(
        self: api_client.Api,
...
class ListFormReviewWorkflowTags(BaseApi):
    ...
    def list_form_review_workflow_tags(
        ...
        return self._list_form_review_workflow_tags_oapg(
