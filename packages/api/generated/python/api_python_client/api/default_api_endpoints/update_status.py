...
# body param
SchemaForRequestBodyApplicationJson = UpdateStatusInput


request_body_update_status_input = api_client.RequestBody(
    content={
...
_path = '/documents/{documentId}/forms/{formId}/status'
_method = 'PUT'
...
class UpdateStatus(api_client.Api):
    ...
    def update_status(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_status_input.serialize(body, content_type)
